...
import { tripCategories } from '@/utils/constant';
                ...
                <Form className='space-y-6'>
                  ...
                  <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
                    ...
                    <div className='space-y-2'>
                      ...
                      <Field
                        as='select'
                        name='country'
                        className='w-full h-12 text-lg border-2 rounded px-4 focus:border-[#5f8cab]'
                  ...
                  <div className='space-y-2'>
                    <label
                      ...
                      className='text-sm font-semibold text-gray-700 flex items-center gap-2'
                    >
                      <FileText className='w-4 h-4' /> Trip Category
                    </label>
                    <Field
                      as='select'
                      name='category'
